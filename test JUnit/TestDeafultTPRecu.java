...
public class TestDeafultTPRecu {
	...
	public void testForEachCajas() {
		...
		for (Caja c: h1){
			area_caja_mayor = Math.max(area_caja_mayor, c.espacioOcupa());
		}
